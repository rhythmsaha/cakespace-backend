...
exports.getSubCategories = asyncHandler(async (req, res) => {
  ...
  if (!categorySlug) throw new AppError("Slug is Required", 400);

  const category = await Category.findOne({ slug: categorySlug }).populate("subCategories").select("subCategories");
